...
class DRACLM(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # lr_scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=self.hparams.decay_step, gamma=0.1, verbose=True)
        # lr_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[5, 15, 25], gamma=0.1, verbose=True)
        # lr_scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.8, patience=5, verbose=True, min_lr=1e-6)
