...
def fundus_augment_pool():
    ...
    augs = [
        ...
        (ShearX, 0.3, None),
        (ShearY, 0.3, None),
        (TranslateXConst, 512 // 8, None),
        (TranslateYConst, 512 // 8, None),
        #(CutoutConst, 512 // 8, None),
    ]
    return augs
...
class RandAugmentFUNDUS(object):
    def __init__(self, n=2, m=16, resample_mode=PIL.Image.BICUBIC, fill=(128, 128, 128)):
        global RESAMPLE_MODE, FILL_COLOR
        RESAMPLE_MODE = resample_mode
        FILL_COLOR = fill
        self.n = int(n)
        self.m = m
        self.augment_pool = fundus_augment_pool()
